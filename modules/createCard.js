...
export function createMovieCard(element) {
    ...
    createPosterImg.srcset = `
    https://image.tmdb.org/t/p/w200${element.img_url} 200w,
    https://image.tmdb.org/t/p/w500${element.img_url} 500w,
    https://image.tmdb.org/t/p/w800${element.img_url} 800w
    `;
